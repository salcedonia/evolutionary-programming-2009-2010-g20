...
public class ValidadorDatos {
	...
	private boolean profundidadMaximaOk() {
		...
		try {
			...
			if (_ventana.getTxtProfundidadMaxima().getText().matches("")) {
				JOptionPane.showMessageDialog(_ventana,
						"!Debe introducir la Profundidad Maxima del arbol!",
						"Error en los datos", JOptionPane.ERROR_MESSAGE);
				return false;
			} else {
				profundidadMaxima = Integer.parseInt(_ventana.getTxtProfundidadMaxima().getText());

				if (profundidadMaxima < 0) {
					JOptionPane
							.showMessageDialog(
									_ventana,
									"!La Profundidad Maxima del arbol tiene que ser un numero entero positivo!",
									"Error en los datos",
			...
			JOptionPane.showMessageDialog(_ventana,
					"!La Profundidad Maxima del arbol tiene que ser un numero entero!",
					"Error en los datos", JOptionPane.ERROR_MESSAGE);
