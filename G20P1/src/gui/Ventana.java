...
public class Ventana extends JFrame {
	...
	/**
	 * Etiqueta de tamaÒo de la Èlite.
	 */
	...
	/**
	 * Campo de texto para el % de tamaÒo de la Èlite.
	 */
	 ...
	 * 
	 * @return El panel para mostrar las gr√°ficas correspondientes a la
	 *         funci√≥n.
	 */
	...
	private void creaBodyOpciones() {
		...
		_lblTamElite = new JLabel("TamaÒo de la …lite:");
		constraints.gridx = 0;
		constraints.gridy = 8;
		constraints.fill = GridBagConstraints.BOTH;
	...
	private void comenzarAGS() {
		...
		while (!_AG.terminado()) {
			...
			// No hace nada si no la opciÛn elitismo est· inactiva
			_AG.separaElite(); 
	...
	/**
	 * Devuelve el campo de texto del porcentage de Èlite.
	 * 
	 * @return El campo de texto del porcentage de Èlite.
	 */
