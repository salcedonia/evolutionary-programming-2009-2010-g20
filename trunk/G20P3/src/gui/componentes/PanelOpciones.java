...
public class PanelOpciones extends JPanel{
	...
	public PanelOpciones(final Ventana ventana){
		...
		_lblProfundidadMaxima = new JLabel("Profundidad Maxima Arbol:");
		constraints.anchor = GridBagConstraints.WEST;
		constraints.gridx = 1;
		constraints.gridy = 7;
		constraints.insets = new Insets(0,30,0,0);
		add(_lblProfundidadMaxima, constraints);
		...
		_txtProfundidadMaxima = new JTextField(PROFUNDIDAD_MAXIMA_DEF);
		_txtProfundidadMaxima.setColumns(3);
		constraints.anchor = GridBagConstraints.WEST;
		constraints.gridx = 1;
		constraints.gridy = 7;
		constraints.insets = new Insets(0,225,0,0);
		add(_txtProfundidadMaxima, constraints);
	...
	/**
	 * Devuelve el campo de texto con la profundidad maxima del arbol.
	 * 
	 * @return El campo de texto con la profundidad maxima del arbol.
	 */
