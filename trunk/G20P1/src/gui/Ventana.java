...
/**
 * Clase que implementa los m脠todos necesarios para la gesti脹n de la ventana
 * gr路fica del usuario.
 * 
 * @author Grupo20.
 * 
...
public class Ventana extends JFrame {
	...
	public Ventana() {
		...
		// Set de las caracter脤sticas de la ventana
		...
		// Inicializaci脹n de los elementos de la ventana
		iniciaInterfaz();
		setEnabled(true);
		setVisible(true);
	}
	...
	/**
	 * Crea el panel para mostrar las gr谩ficas correspondientes a la funci贸n.
	 * 
	 * @return El panel para mostrar las gr谩ficas correspondientes a la funci贸n.
	 */
	...
	/**
	 * Crea el panel para mostrar las gr谩ficas correspondientes a la aptitud.
	 * 
	 * @return El panel para mostrar las gr谩ficas correspondientes a la aptitud.
	 */
	...
	private JPanel creaPanelPrincipal() {
		...
		// Aniadimos todas las opciones de la aplicaci脹n.
	...
	/**
	 * Crea el panel con todas las opciones de la aplicaci脹n.
	 * 
	 * @return El panel con todas las opciones de la aplicaci脹n.
	 */
	private JPanel creaPanelOpciones() {
		...
		// Aniade los botones de la aplicaci脹n.
		creaBotonesOpciones();
	 ...
	 * los elementos de configuraci脹n del AGS.
	 */
	private void creaBodyOpciones() {
		...
		_lblTamPoblacion = new JLabel("Tama帽o de la Poblacion:");
		constraints.gridx = 0;
		constraints.gridy = 2;
		constraints.fill = GridBagConstraints.BOTH;
	...
	private void inicializaGraficas() {
		...
		// Creaci髇 de los vectores para almacenar las x
